...
> **Архивный документ.** Описание внедряемой фичи; часть сведений (в т.ч. схема БД в §3) может не совпадать с текущей реализацией. Актуальные контракты: [CONTRACTS.md](../../CONTRACTS.md). Схема БД: [CherryPlayServer/DATABASE.md](../../CherryPlayServer/DATABASE.md).
