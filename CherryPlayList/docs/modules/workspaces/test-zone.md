...
При импорте модуля регистрируются все эти типы в `WorkspaceRegistry`, после чего их можно использовать в layout пресетах и при **динамическом** добавлении зон в [режиме редактирования layout](../../layout-edit-mode.md) (picker в шапке «Редактировать»).
