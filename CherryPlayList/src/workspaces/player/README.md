...
4. **Настройки воспроизведения**
   ...
   - Действие после трека: сплошное воспроизведение / «Без паузы» (сразу к следующему), интервал между треками (ожидание), **пауза в конце трека** (без автоперехода; дальше — «Следующий»)
...
- **Режим подготовки**: все кнопки управления (Play, Pause, Stop, Next) неактивны. Доступна кнопка предпрослушивания трека в демо-плеере (floating / зона `demo-player`).
- **Режим активной сессии**: все кнопки управления активны. Кнопка предпрослушивания у трека **остаётся видимой**; при блокировке звука demo UI открывается с «Воспроизведение невозможно». Кнопка **«Начать проигрывание»** меняется на **«Остановить проигрывание»**.
