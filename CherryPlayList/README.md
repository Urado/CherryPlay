...
**Редактирование layout:** см. **[docs/layout-edit-mode.md](docs/layout-edit-mode.md)** — добавление и удаление workspace в UI.
...
- ✅ Гибкая система layout с поддержкой множественных workspace ([режим редактирования](docs/layout-edit-mode.md))
