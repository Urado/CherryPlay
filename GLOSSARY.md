...
| → `completed`                        | **В архив** — конец ряда действий модала настроек; при **Конец** — пункт меню chip **«Архивировать»** (`archivePartyFromHeader`); также **Мои вечеринки** (с confirm; для linked — archive availability) |
