...
| Термин                   | Описание                                                                                                                                                                                                                                                                                           |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **session** (сессия)     | **Код:** `sessionState.mode === 'session'` в зоне Проигрывание. **UI:** **«Начать проигрывание»** / **«Остановить проигрывание»**. При **Онлайн** и `linkedParty` на сайт уходит **состояние**, не звук. См. таблицу UI ниже.                                                                      |
| **preparation**          | Режим подготовки: редактирование плейлиста и настроек без трансляции «сейчас играет» зрителям.                                                                                                                                                                                                     |
| **Publish**              | **Код/API:** PUT плейлиста. **UI:** **«Обновить на сайте»** / **«Обновить для гостей»**.                                                                                                                                                                                                           |
...
| ----------------------------------- | ---------------------------------------------- |
| `enableStreaming`                   | **Онлайн** / **Работа без сети**               |
| `streamingSource`                   | **Источник состояния для гостей**              |
| `linkedParty`                       | **Подключено к вечеринке**                     |
| lifecycle draft / ready / completed | **Не на сайте** / **Опубликована** / **Архив** |
