...
| Термин | Описание |
|--------|----------|
| **organizer** | Организатор вечеринки. Владелец данных; может создавать/редактировать вечеринки, публиковать плейлист, управлять сессией. Входит через JWT (OAuth провайдеры: Telegram, VK, Mail.ru в v1). |
